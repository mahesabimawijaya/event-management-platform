...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white fixed w-full shadow py-2 md:flex md:items-center md:justify-between md:px-8 z-10">
      ...
      >
        <Link href={"/about"}>
          <div className="my-5 md:my-0">About</div>
        </Link>
        <Link href={"/events"}>
          <div className="my-5 md:my-0">Events</div>
        </Link>
        <Link href={"/teams"}>
          <div className="my-5 md:my-0">Teams</div>
        </Link>
        <div className="flex flex-col w-40 md:w-auto space-y-2 mt-10 md:mt-0 md:space-y-0 md:flex-row md:pl-10 md:space-x-5 md:items-center mb-5 md:mb-0">
          ...
          <Link href={"register"}>
            <button className="border border-violet-600 py-2 px-4 rounded text-violet-600 cursor-pointer hover:bg-violet-600 duration-150 hover:text-white">
              Register
            </button>
          </Link>
        </div>
